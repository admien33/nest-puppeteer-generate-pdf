...
import { ProductController } from './generate-pdf.controller';
import { GeneratePdfService, ProductService } from './generate-pdf.service';
...
describe('GeneratePdfService', () => {
  ...
  let productService: GeneratePdfService;
